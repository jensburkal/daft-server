...
var MooTools={
    ...
    }D.prototype.constructor=D;if(A){
        var E=A.toLowerCase();D.prototype.$family={
            name:E
        };Native.typize(D,E);
...
function $A(C){
    ...
    var A=$type(B);return(A)?((A!="array"&&A!="arguments")?[B]:B):[];
...
var Event=new Native({
    ...
    initialize:function(B){
        B=B||{};var A=function(){
            for(var E in this){
                ...
                }this.constructor=A;if(Class.prototyping){
                return this;
            }var D=(this.initialize)?this.initialize.apply(this,arguments):this;if(this.options&&this.options.initialize){
        ...
        }$extend(A,this);A.constructor=Class;A.prototype=B;
        return A;
    }
    });Class.Mutators={
    ...
    Implements:function(A,B){
        $splat(B).each(function(C){
            Class.prototying=C;$extend(A,($type(C)=="class")?new C:C);delete Class.prototyping;
        });return A;
    }
    };Class.extend({
    ...
    override:function(B,A,E){
        var D=Class.prototyping;if(D&&B[A]!=D[A]){
            D=null;
        }var C=function(){
    ...
    $chain:[],
    chain:function(){
        this.$chain.extend(Array.flatten(arguments));return this;
    },
    callChain:function(){
    ...
    $$:function(A){
        ...
        }var F=[];var C=Array.flatten(arguments);
    ...
    $uid(A);if(!D&&!A.$family&&!(/^object|embed$/i).test(A.tagName)){
        var B=Element.Prototype;for(var C in B){
            A[C]=B[C];
        }
        }return A;
    ...
    Native.implement([Element,Document],{
        ...
        var C=function(L){
            ...
            if(!N){
                return ;
            }var M=N.uid;if(Browser.Engine.trident){
                if(N.clearAttributes){
                    var P=L&&N.cloneNode(false);
                    N.clearAttributes();if(P){
                        N.mergeAttributes(P);
                    }
                    }else{
                    if(N.removeEvents){
        ...
        Hash.extend(E,B.associate(B));Hash.extend(E,K.associate(K.map(String.toLowerCase)));var A={
            ...
            getProperties:function(){
                var L=$A(arguments);return L.map(this.getProperty,this).associate(L);
            },
            ...
            removeClass:function(L){
                this.className=this.className.replace(new RegExp("(^|\\s)"+L+"(?:\\s|$)"),"$1");return this;
            },
            ...
            grab:function(M,L){
                A[L||"bottom"]($(M,true),this);return this;
            },
            inject:function(M,L){
                A[L||"bottom"](this,$(M,true));return this;
            },
            replaces:function(L){
                L=$(L,true);
            ...
            wraps:function(M,L){
                M=$(M,true);return this.replaces(M).grab(M,L);
            },
            ...
            clone:function(O,L){
                ...
                var R=this.cloneNode(O);var N=function(V,U){
                    if(!L){
                        ...
                        if(V.options){
                            var W=V.options,S=U.options;for(var T=W.length;T--;){
                    ...
                    var P=R.getElementsByTagName("*"),Q=this.getElementsByTagName("*");for(var M=P.length;M--;){
                        N(P[M],Q[M]);
                    }
                    }N(R,this);return $(R);
            },
            ...
            retrieve:function(M,L){
                var O=C(this.uid),N=O[M];if(L!=undefined&&N==undefined){
                    N=O[M]=L;
                }return $pick(N);
            },
            store:function(M,L){
                var N=C(this.uid);N[M]=L;return this;
            },
            eliminate:function(L){
                var M=C(this.uid);delete M[L];return this;
            }
        ...
        Element.Properties.text={
            get:function(){
                if(this.innerText){
                    ...
                    html:this.innerHTML
                    }).inject(this.ownerDocument.body);var B=A.innerText;A.destroy();return B;
            }
            };
        ...
        addEvent:function(E,G){
            var H=this.retrieve("events",{});H[E]=H[E]||{
                keys:[],
                values:[]
                ...
                return G.call(I);
            };var B=Element.NativeEvents[F];if(B){
                if(B==2){
                    D=function(J){
        ...
        removeEvent:function(C,B){
            var A=this.retrieve("events");if(!A||!A[C]){
                ...
                return this;
            }A[C].keys.splice(F,1);var E=A[C].values.splice(F,1)[0];var D=Element.Events.get(C);if(D){
                if(D.onRemove){
        ...
        removeEvents:function(A){
            ...
            }var B=this.retrieve("events");if(!B){
                return this;
            }if(!A){
                for(var C in B){
                    this.removeEvents(C);
    ...
    Element.ShortStyles={
        ...
        Element.implement({
            ...
            getOffsets:function(){
                if(Browser.Engine.trident){
                    var L=this.getBoundingClientRect(),J=this.getDocument().documentElement;return{
                    ...
                    H.x+=I.offsetLeft;H.y+=I.offsetTop;if(Browser.Engine.gecko){
                        if(!F(I)){
                            H.x+=C(I);H.y+=G(I);
                        }var K=I.parentNode;if(K&&D(K,"overflow")!="visible"){
                            H.x+=C(K);H.y+=G(K);
                        }
                        }else{
            ...
            getCoordinates:function(J){
                ...
                }var H=this.getPosition(J),I=this.getSize();var K={
                    left:H.x,
                    top:H.y,
                    width:I.x,
                    height:I.y
        ...
        Selectors.Utils={
            ...
            search:function(I,H,N){
                var B=[];var C=H.trim().replace(Selectors.RegExps.splitter,function(Y,X,W){
                    ...
                    var S=C[T];if(T==0&&Selectors.RegExps.quick.test(S)){
                        ...
                        continue;
                    }var A=B[T-1];var K=Selectors.Utils.parseTagAndID(S);var V=K[0],L=K[1];if(T==0){
            ...
            "nth-child":function(G,E){
                ...
                if(C.special!="n"){
                    ...
                    while((B=B.previousSibling)){
                        if(B.nodeType!=1){
                            continue;
                        }F++;var A=E.positions[$uid(B)];if(A!=undefined){
                            F=A+F;break;
                        }
                        }E.positions[D]=F;
            ...
            var B=function(){
                if(Browser.loaded){
                    return ;
                }Browser.loaded=true;window.fireEvent("domready");document.fireEvent("domready");
            };if(Browser.Engine.trident){
                ...
                if(Browser.Engine.webkit&&Browser.Engine.version<525){
                    ...
                    window.addEvent("load",B);document.addEvent("DOMContentLoaded",B);
                }
                }
            })();var JSON=new Hash({
            $specialChars:{
        ...
        Fx.Tween=new Class({
            ...
            send:function(I){
                ...
                this.headers.each(function(K,J){
                    ...
                    },this);this.fireEvent("request");this.xhr.send(E);
            ...
            cancel:function(){
                if(!this.running){
                    return this;
                }this.running=false;this.xhr.abort();this.xhr.onreadystatechange=$empty;
